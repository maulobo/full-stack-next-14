      ...
      <div className="mx-auto flex min-h-screen max-w-screen overflow-hidden flex-col items-center justify-center  px-10 py-24 text-4xl font-semibold tracking-tight md:py-28 md:text-6xl lg:px-20 lg:py-3 lg:text-[10rem]">
        <div className="leading-[1.15]">
          <div
            className={cn(
              styles.introText,
              "dark:bg-gradient-to-tr dark:from-[#E0B379] dark:to-[#91f08a] dark:bg-clip-text dark:text-transparent"
            )}
          ...
          <span
            className={cn(
              styles.introText,
              "inline-block after:content-['_'] dark:bg-gradient-to-tr dark:from-[#E0B379] dark:to-purple-300/90 dark:bg-clip-text dark:text-transparent transition-[0.4s]"
            )}
          ...
          <span
            className={cn(
              styles.introText,
              "inline-block transition-[0.4s] dark:bg-gradient-to-tr dark:from-[#E0B379] dark:to-[#e8eaed] dark:bg-clip-text dark:text-transparent"
            )}
